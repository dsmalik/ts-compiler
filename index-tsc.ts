...
compile(['app.ts'], [process.cwd()]);

// prog.getSourceFiles().forEach(x => {
//     console.log('Source file -', x.fileName);

//     const sourceText = ts.sys.readFile(x.fileName);

//     if (sourceText !== undefined) {
//         const sourceTextOutput = ts.createSourceFile(x.fileName, sourceText, ts.ScriptTarget.ES2015);
//         console.log('Source - ', sourceTextOutput)
//     }
// });
